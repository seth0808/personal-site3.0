...
$(document).ready(function(){
  $("#aboutme_traveler").click(function(){
  	if (aboutme_travelerClicked){
    	...
    	$("#aboutme_traveler").append("<p id='aboutme_traveler_newp'> My most recent experience outside the country was in Japan over winter break. It was a fun experience even though sushi is my worst enemy. Last summer I was in Ecuador for my internship (2 months) Press the logo to see where I worked</p>")
  ...
  $("#projects_gropdemo").click(function(){
  	if (projects_gropdemoClicked){
    	...
    	$("#projects_gropdemo").append("<p id='projects_gropdemo_newp'>I\'m really into IOS development. This is a generic social media app that I challenged my self to build last summer. Functions ok, but definitely needs improvement. It\'s called GROP because it\'s for GROUPS that still need U :( The code isn\'t up yet, but for now you can check out this really old app I made for my dining hall.</p> <a target='_blank' href='https://github.com/seth0808/Diner2.0'>GitHub</a>")
  	}else {
  ...
  $("#projects_mazedemo").click(function(){
  	if (projects_mazedemoClicked){
    	...
    	$("#projects_mazedemo").append("<p id='projects_mazedemo_newp'>In my first semester we learned Dijkstra\'s algorithm. I told my friend I could probably use it solve mazes and he said I couldn\'t. </p> <a href='https://github.com/seth0808/MazeSolver'>GitHub</a>")
  	}else {
  ...
  $("#projects_nndemo").click(function(){
  	if (projects_nndemoClicked){
    	...
    	$("#projects_nndemo").append("<p id='projects_nndemo_newp'>Watched a TON of YouTube videos, decided I could put something together, frustrated by the machine learning libraries, and built something without one. My goal was to get the neural net to solve the game by itself. I tried to use something call neural evolution of augmenting topologies. I will be taking a machine learning course this semester so I can find all the flaws in this program. </p> <a target='_blank' href='https://github.com/seth0808/Neural-Network'>GitHub</a>")
  	}else {
  ...
  $("#projects_dsdemo").click(function(){
  	if (projects_dsdemoClicked){
    	...
    	$("#projects_dsdemo").append("<p id='projects_dsdemo_newp'>I think I spent 36 hours straight (literaly) making this entire project. They put the deadline in between finals. But now I think what I found is pretty interesting, so check it out</p> <a href='https://seth0808.github.io/data_science_320_final/'>Data Science Final</a>")
  	}else {
