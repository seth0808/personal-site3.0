...
if (iOS) {
  ...
  $("#aboutme_developer").click(function(){
  	if (aboutme_developerClicked){
  		$("#aboutme_developer_video").remove()
    	$("#aboutme_developer_p").remove()
    	$("#aboutme_developer").append("<p id='aboutme_developer_newp'>Just finished wokring at Verizon Connect as a Software Engineer Intern. Press on my LinkedIn (That video was after an all-nighter at the Georgia Tech Hackathon)</p>")
  ...
  $("#aboutme_cinematographer").click(function(){
    ...
    aboutme_cinematographerClicked = !aboutme_cinematographerClicked;
  	...
  	if (aboutme_studentClicked){
  		$("#aboutme_student_video").remove()
    	$("#aboutme_student_p").remove()
    	$("#aboutme_student").append("<p id='aboutme_student_newp'>GO TERPS. We always strive ahead only because the actual Terrapin creature is physically incapable of walking backwards. Currently taking my upper levels in CS and just graduated from the Entrepreneurship and Innovation Honors College. (Really good at spelling entrepreneurship)</p>")
